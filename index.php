...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* ═══════════════════════════════════════
           DARK MODE — original gold design
        ═══════════════════════════════════════ */
        :root {
            --gold:         #c9a84c;
            --gold-light:   #e2c97e;
        ...
        .panel-left::before {
            ...
            position: absolute; inset: 0;
            background:
                radial-gradient(ellipse 100% 60% at 0% 0%, var(--panel-l-glow1) 0%, transparent 60%),
                radial-gradient(ellipse 80% 80% at 100% 100%, var(--panel-l-glow2) 0%, transparent 60%);
        ...
        .brand-icon {
            ...
            box-shadow: 0 0 20px var(--gold-dim), inset 0 1px 0 rgba(255,255,255,.1);
            transition: all .35s;
        }
        .brand-name {
        ...
        .login-alert {
            ...
            font-size: .82rem; color: var(--err-txt); font-weight: 500;
        ...
        .field-label {
            ...
            margin-bottom: .5rem; transition: color .35s;
        }
        ...
        .field-input:-webkit-autofill:focus {
            box-shadow: 0 0 0 1000px var(--input-bg) inset, 0 0 0 3px var(--focus-ring) !important;
        ...
        .btn-signin:hover:not(:disabled) {
            transform: translateY(-1px);
            box-shadow: 0 8px 28px var(--btn-shadow-h);
        }
        ...
        .lock-hint {
            ...
            font-size: .78rem; color: var(--lock-txt); font-weight: 500;
...
(function () {
    ...
    // Default = dark. Light mode opt-in saved to localStorage + cookie.
    ...
    function setTheme(isLight) {
        ...
        // Sync darkMode cookie so dashboard/header.php picks it up automatically
