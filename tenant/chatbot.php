...
async function sendChatMessage() {
    ...
    try {
        ...
        addMessage('assistant', '<strong>Error:</strong> Unable to reach the AI assistant. The Groq AI service may be down. Please try again later or contact your admin.<br><small>Get free key: <a href="https://console.groq.com" target="_blank">console.groq.com</a></small>');
        console.error(err);
    } finally {
